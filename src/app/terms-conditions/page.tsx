        ...
        <Card className="border-none shadow-none bg-transparent">
          <CardContent className="text-left text-muted-foreground space-y-6">
            ...
            <section className="space-y-2">
                ...
                <p>TypeRush provides users with a gamified typing practice platform. The service is provided "as is" and the creators of TypeRush assume no responsibility for the timeliness, deletion, or failure to store any user data.</p>
            </section>
            <section className="space-y-2">
