...
const LiveStats = ({ wpm, accuracy, timeLeft }: LiveStatsProps) => {
  ...
  const StatCard = ({ value, label }: { value: string | number, label: string }) => (
    <Card className="flex flex-col items-center justify-center p-4 h-28 bg-card border-none shadow-sm">
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-1 gap-4">
      <Card className="col-span-2 lg:col-span-1 flex flex-col items-center justify-center p-4 h-32 bg-primary text-primary-foreground border-none shadow-sm">
